...
class SuccessCreateCarDialog extends StatefulWidget {
  final String message;
  final bool isEditMode;
  const SuccessCreateCarDialog({
    super.key,
  ...
  @override
  State<SuccessCreateCarDialog> createState() => _SuccessCreateCarDialogState();
}

class _SuccessCreateCarDialogState extends State<SuccessCreateCarDialog> {
  @override
  void initState() {
    super.initState();
